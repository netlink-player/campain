  ...
  function InnityAppsAdSdkHelper(opts) {
    ...
    async function notchCheckSolved_(isNotch) {
      if (isNotch === true) {
        ...
        // Demo Purposes
      	if (curWin.innerHeight - screenSize.height < 40)
        	closeBtnExtraOffset_ = curWin.innerHeight > 800 ? 44 : 20;
      }
